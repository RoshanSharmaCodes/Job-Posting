...
export default function EditJob() {
    ...
    const {
      ...
      const onSubmit = (data) => {
        ...
        fetch(`http://localhost:3000/update-job/${id}`, { method: "PATCH", headers: { "content-type": "application/json" }, body: JSON.stringify(data) })
          .then((data) => data.json())
          .then((result) => {
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="create-job-flex">
          ...
          <div className="lg:w-1/2 w-full">
            ...
            <input type="text" placeholder="Ex: Microsoft" defaultValue={data.companyName} {...register("companyName")} className="create-job-input" />
          </div>
        </div>
        ...
        <div className="create-job-flex">
          ...
          <div className="lg:w-1/2 w-full">
            ...
            <input type="url" defaultValue={data.companyLogo} placeholder="https://www.company.com/logo.png" {...register("companyLogo")} className="create-job-input" />
          </div>
        </div>
        ...
        <div className="create-job-flex">
          <div className="lg:w-1/2 w-full">
            ...
            <input type="email" defaultValue={data.jobPostedBy} placeholder={"hr@domain.com"} {...register("jobPostedBy")} className="create-job-input" />
          </div>
        </div>
